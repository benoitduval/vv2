    ...
    'assets' => [
        ...
        Controller\UserController::class . '::profile' => [
            'js'  => [
                ...
                '/global/js/Plugin/bootstrap-datepicker.js',
                '/global/js/Plugin/asscrollable.js',
                '/assets/examples/js/advanced/scrollable.js',
                '/assets/examples/js/forms/uploads.js',
                '/assets/examples/js/layouts/panel-transition.js',
            ],
            'css' => [
                '/global/vendor/animsition/animsition.css',
                '/global/vendor/switchery/switchery.css',
                ...
                '/global/vendor/bootstrap-datepicker/bootstrap-datepicker.css',
                '/global/vendor/asscrollable/asScrollable.css',
                '/assets/examples/css/advanced/scrollable.css',
                '/assets/examples/css/dashboard/team.css',
                '/assets/examples/css/pages/profile_v3.css',
                '/assets/examples/css/layouts/panel-transition.css',
            ]
        ]
    ]
];